...
///
/// this file contains:
/// [SampleTableCalendarEvent]
/// [_SampleTableCalendarEventViewCalendar]
/// [_SampleTableCalendarEventElementHeader]
/// [_SampleTableCalendarEventElementTail]
/// [_SampleTableCalendarEventViewEventDetail]
/// [_SampleTableCalendarEventViewEventModification]
///
/// TODO: complete all the event usage, no matter calendar event or other type of event
///
///
...
class _SampleTableCalendarEventState extends State<SampleTableCalendarEvent> {
  ...
  Processor<CalendarEvent> _showOverlay(bool isModificationView) => (event) {
        ...
        _overlay.addFadingEntry(
          ...
          builder: isModificationView
              ? (context) => Preference(
                    child: _SampleTableCalendarEventViewEventModification(
                      event: event,
                      onCancelButtonPressed: _hideLastOverlayEntry,
                      onSaveButtonPressed: _hideLastOverlayEntry,
                    ),
                  )
              : (context) => Preference(
                    child: _SampleTableCalendarEventViewEventDetail(
                      event: event,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: context.preference.appColor.colorB1,
      body: Padding(
        padding: KEdgeInsets.symH_8,
        child: _SampleTableCalendarEventViewCalendar(
...
class _SampleTableCalendarEventViewCalendar extends StatefulWidget {
  const _SampleTableCalendarEventViewCalendar({
    super.key,
    required this.onShowViewEventModification,
    required this.onShowViewEventDetail,
  });

  final Processor<CalendarEvent> onShowViewEventModification;
  final Processor<CalendarEvent> onShowViewEventDetail;

  @override
  State<_SampleTableCalendarEventViewCalendar> createState() =>
      _SampleTableCalendarEventViewCalendarState();
}

class _SampleTableCalendarEventViewCalendarState
    extends State<_SampleTableCalendarEventViewCalendar> {
    ...
    return Column(
      ...
      children: [
        _SampleTableCalendarEventElementHeader(
          ...
          onTodayButtonTap: setStateOf(() => _focusedDay = DateTime.now()),
        ...
        SizedBox(
          ...
          child: Padding(
            ...
            child: TableCalendar(
              ...
              selectedDayPredicate: FPredicator.isSameDayWith(_selectedDay),
              onDaySelected: (selectedDay, focusedDay) => setState(() {
                if (!FDateTime.isSameDay(_selectedDay, selectedDay)) {
...
class _SampleTableCalendarEventElementHeader extends StatefulWidget {
  const _SampleTableCalendarEventElementHeader({
    super.key,
    this.height = 40.0,
  ...
  @override
  State<_SampleTableCalendarEventElementHeader> createState() =>
      _SampleTableCalendarEventElementHeaderState();
}

class _SampleTableCalendarEventElementHeaderState
    extends State<_SampleTableCalendarEventElementHeader> {
  ...
  void didUpdateWidget(
    covariant _SampleTableCalendarEventElementHeader oldWidget,
  ) {
    _headerHeight = widget.height;
  ...
  Widget build(BuildContext context) {
    ...
    // TODO: build direction for next month, next year
    return Row(
      children: [
        IconButton(
          splashRadius: 16,
          icon: KIconMaterial.chevronLeft,
          iconSize: _headerHeight / 2,
          onPressed: () {
            widget.onLeftArrowTap();
            // TODO: insert previous title widget in here, but do it after have a nice [CustomAnimatedList], and more generic calendar header arrow
          },
        ),
        KSpacer.none,
        AnimatedContainer(
        ...
        IconButton(
          splashRadius: 16,
          icon: KIconMaterial.chevronRight,
          iconSize: _headerHeight / 2,
          onPressed: () {
            widget.onRightArrowTap();
            // TODO: insert next title widget in here, but do it after have a nice [CustomAnimatedList], and more generic calendar header arrow
          },
        ),
      ],
    );
  ...
  Widget get _todayButton => IconButton(
        ...
        icon: KIconMaterial.calendarToday,
        iconSize: _headerHeight / 2,
        onPressed: () {
...
class _SampleTableCalendarEventElementTail extends StatefulWidget {
  const _SampleTableCalendarEventElementTail({
    super.key,
    this.updateRemoveThenAdd = true,
  ...
  final Processor<CalendarEvent> eventOnTap;

  @override
  State<_SampleTableCalendarEventElementTail> createState() =>
      _SampleTableCalendarEventElementTailState();
}

class _SampleTableCalendarEventElementTailState
    extends State<_SampleTableCalendarEventElementTail> {
  final List<CalendarEvent> _selectedEvents = <CalendarEvent>[];
  ...
  @override
  void didUpdateWidget(
      covariant _SampleTableCalendarEventElementTail oldWidget) {
    _selectedDate = widget.selectedDate;
    final oldEvents = oldWidget.eventListForDay;
    final newEvents = widget.eventListForDay;
    if (_selectedEvents.isNotEmpty) {
      // TODO: update items in CustomAnimatedList
      ...
      ///
      final intersection = oldEvents.intersectionWith(newEvents);
      final toRemoved = oldEvents.differenceIndexWith(newEvents);
      final toAdded = newEvents.differenceWith(oldEvents);
      ...
      for (var added in toAdded.entries) {
        ...
        _selectedEvents.insert(index, added.value);
        ...
        child: AnimatedOpacity(
          ...
          child: Container(
            decoration: ShapeDecoration(
              ...
              shape: KInputBorderOutline.none,
            ),
            child: AnimatedList(
              key: _key,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: context.preference.appColor.colorB3,
                    ),
                    onPressed: () => widget.eventOnTap(event),
                    child: const Center(child: KIconMaterial.readMore),
                  ),
                ),
              ],
            ),
...
class _SampleTableCalendarEventViewEventDetail extends StatefulWidget {
  const _SampleTableCalendarEventViewEventDetail({
    super.key,
    required this.event,
  ...
  final Processor<CalendarEvent> onEditButtonPressed;

  @override
  State<_SampleTableCalendarEventViewEventDetail> createState() =>
      _SampleTableCalendarEventViewEventDetailState();
}

class _SampleTableCalendarEventViewEventDetailState
    extends State<_SampleTableCalendarEventViewEventDetail> {
  ...
  @override
  void didUpdateWidget(
      covariant _SampleTableCalendarEventViewEventDetail oldWidget) {
...
class _SampleTableCalendarEventViewEventModification extends StatefulWidget {
  const _SampleTableCalendarEventViewEventModification({
    super.key,
    required this.event,
  ...
  @override
  State<_SampleTableCalendarEventViewEventModification> createState() =>
      _SampleTableCalendarEventViewEventModificationState();
}

class _SampleTableCalendarEventViewEventModificationState
    extends State<_SampleTableCalendarEventViewEventModification> {
